...
<!-- content css -->
<%@ include file="../resources/cssjs/resumeInsertCss.jsp" %>
<!-- footer css -->
            ...
            <div id="content_wrap" class="parent">
                ...
                <div id="section" class="left">
                    <div id="top_section_wrap" class="parent">
                        ...
                        <ul class="left info">
                            <li><h3>휴대폰</h3><input type="text"/></li>
                            <li><h3>이메일</h3><input type="text"/></li>
                            <li><h3>주소</h3><input type="text"/></li>
                        </ul>
                    </div>
                    
                    <ul class="info">
                        <li><h3>희망지역</h3><input type="text"/></li>
                        <li><h3>경력</h3><input type="text"/></li>
                        <li><h3>자격증</h3><input type="text"/></li>
                        <div></div>
